...
#define COMMAND_MAX_LEN 16   /* 每条命令及参数的最大长度 */
#define COMMAND_MAX_TIP 128  /* 命令说明的最大长度 */
#define PROMT_MAX_LEN   16   /* 提示符的最大长度 */
#define INPUT_MAX_LEN   2048 /* 输入的最大长度 */
#define INPUT_ARG_CNT   128  /* 输入中参数的最大个数 */
#define ARGS_MAX_LEN    128  /* 输入中参数的最大长度 */
#define ERR_MSG_LEN     128  /* 错误提示的最大长度 */
